...
class WorldSetupHook extends Hook {
  ...
  Future<void> onAfterScenarioWorldCreated(
    ...
    if (world is StepWorld) {
      print(
        '[WorldSetupHook] onAfterScenarioWorldCreated - World is StepWorld. Performing explicit setup...',
      );
      ...
      try {
        print(
          '[WorldSetupHook] onAfterScenarioWorldCreated - Explicit setup completed. Provider state: ${world.provider.state}',
        );
      } catch (e) {
        print(
          '[WorldSetupHook] onAfterScenarioWorldCreated - Explicit setup completed, but error accessing provider state: $e',
        );
      }
    } else {
      print(
        '[WorldSetupHook] onAfterScenarioWorldCreated - World is NOT StepWorld. Type: ${world.runtimeType}',
      );
    }
  }
}
