...
class Value extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<Value> createRepeated() => $pb_list.newPbList<Value>();
  @$core.pragma('dart2js:noInline')
...
class EvaluationRequest extends $pb.GeneratedMessage {
  ...
  factory EvaluationRequest.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) => create()..mergeFromBuffer(i, r);
  factory EvaluationRequest.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) => create()..mergeFromJson(i, r);
  static final $pb.BuilderInfo _i =
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary.')
  EvaluationRequest copyWith(void Function(EvaluationRequest) updates) =>
      super.copyWith((m) => updates(m as EvaluationRequest))
  ...
  @$core.pragma('dart2js:noInline')
  static EvaluationRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<EvaluationRequest>(create);
  static EvaluationRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get flagKey => $_getSZ(0);
  @$pb.TagNumber(1)
  set flagKey($core.String v) {
    $_setString(0, v);
  }
...
class EvaluationResponse extends $pb.GeneratedMessage {
  factory EvaluationResponse({
    ...
    if (evaluatedAt != null) {
      _result.evaluatedAt = evaluatedAt;
    }
    return _result;
  }
  EvaluationResponse._() : super();
  factory EvaluationResponse.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) => create()..mergeFromBuffer(i, r);
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary.')
  EvaluationResponse copyWith(void Function(EvaluationResponse) updates) =>
      super.copyWith((m) => updates(m as EvaluationResponse))
  ...
  @$core.pragma('dart2js:noInline')
  static EvaluationResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<EvaluationResponse>(create);
